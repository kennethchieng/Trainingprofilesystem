...
<html lang="en">
<head>
  <title>Training Profile System | Login</title>
  <meta charset="UTF-8">
    ...
    <div class="container-login100">
      ...
      <div class="wrap-login100">
        <div class="login100-pic js-tilt" data-tilt>
          <img src="images/manred.jpg" alt="IMG">
		  <!--<img src="images/hornbill.png" alt="IMG">
		  <h3 style=text-align:center;>Ministry of Modernization of Agrilculture, Native Land, and Regional Development</h3>-->
        </div>
      ...
      <!--     <div class="text-center p-t-12">
          ...
          <div class="text-center p-t-136">
            ...
            <a class="txt2" href="admin\login.php">
              <p style=text-align:center;>Login as Administrator
              <i class="fa fa-long-arrow-right m-l-5" aria-hidden="true"></i></p>
            </a>
        </form>
      </div>
    </div>
