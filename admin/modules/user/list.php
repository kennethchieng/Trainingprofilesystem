				  ...
				  <tbody>
				  	<?php 
						...
						foreach ($cur as $result) {
				  		...
				  		echo '<td > <a title="Edit" href="index.php?view=edit&id='.$result->USERID.'" class="btn btn-primary btn-xs" ><i class="fa fa-edit fa-fw" ></i></a>
				  					 <a title="Delete" href="controller.php?action=delete&id='.$result->USERID.'" class="btn btn-danger btn-xs" ><i class="fa fa-trash-o  fa-fw"></i> </a>
				  					 </td>';
				  		echo '</tr>';
				  	} 
				  	?>
