...
<title>Training Profile System | <?php echo $title;?></title>
...
<div class="navbar-header">
  ...
  <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >Training Profile System </a>
</div>

  <ul class="nav navbar-top-links navbar-right" >
   <li class="dropdown">
    <a class="dropdown-toggle" data-toggle="dropdown" href="<?php echo web_root; ?>admin/index.php">
...
<div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
				 <li><a href="<?php echo web_root; ?>admin/modules/lesson/index.php"><i class="fa fa-book fa-fw"></i> Lesson</a></li>
                 <li><a href="<?php echo web_root; ?>admin/modules/exercises/index.php"><i class="fa fa-book fa-fw"></i> Exercises</a></li>
				 <li><a href="<?php echo web_root; ?>admin/modules/announcement/index.php"><i class="fa fa-bullhorn fa-fw"></i> Announcement</a></li>
				 <li><a href="<?php echo web_root; ?>admin/modules/score/index.php"><i class="fa fa-slack fa-fw"></i> Student Score</a></li>
                 <li><a href="<?php echo web_root; ?>admin/modules/modstudent/index.php"><i class="fa fa-group fa-fw"></i> Students</a></li>
