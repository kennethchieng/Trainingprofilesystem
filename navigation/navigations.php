...
<section id="title-header">
  <div class="title">  
     <img class="logo" src="images/hornbill2.png"><h4>Ministry of Modernization of
      <br>Agriculture, Native Land, and Regional Development</h4>
      <p class="subtitle">Training Profile System</p> 
  </div>
</section>  
<section id="navigation">
  <div id="mySidenav" class="sidenav">
	<a href="<?php echo web_root; ?>index.php?q=home" id="home">Home <i class="fa fa-home"></i></a>
    ...
    <a href="<?php echo web_root; ?>index.php?q=lesson" id="lesson">Lesson</a>
	<!--<a href="<?php echo web_root; ?>index.php?q=work" id="work">Work</a>-->
	<a href="<?php echo web_root; ?>index.php?q=profile" id="profile">Profile</a> 
