...
<form class="form-horizontal span6" action="controller.php?action=pedit" method="POST"  />
	<div class="row">
		<div class="col-lg-12">
            <h1 class="page-header">Edit User's Details</h1>
        </div>
          <!-- /.col-lg-12 -->
	</div>
...
<input  id="StudentID" name="StudentID"  type="hidden" value="<?php echo $singlestudent->StudentID; ?>">
	...
	<div class="form-group">
			<div class="col-md-8">
				<label class="col-md-4 control-label" for="StudentID"></label>
					<div class="col-md-8">
                        <button class="btn btn-primary btn-sm" name="btnPass" type="submit" ><span class="fa fa-save fw-fa"></span> Change Password</button> 
                    </div>
			</div>
	</div>
</form>
